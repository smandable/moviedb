...
includeExternalScripts("js/checkFilesToNormalize.js");
...
// function getProgress(totalNumFiles) {
//     console.info(totalNumFiles);
//     $.ajax({
//         url: "php/progress.php",
//         success: function(data) {
...
function getFiles(directory) {
    $.ajax({
        ...
        handleGetFilesResult(response);
    });
}

function handleGetFilesResult(response) {
    //totalNumFiles = response;
    //console.info("totalNumFiles: ", totalNumFiles);
    checkFilesToNormalize();
